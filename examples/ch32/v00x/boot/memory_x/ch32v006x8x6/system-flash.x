/* CH32V006 system-flash bootloader memory layout (62K flash, 8K RAM).
 *
 * The bootloader runs from system flash at 0x1FFF0000.
 * All 62 KB of user flash is available for the application.
...
MEMORY
{
    ...
    APP  : ORIGIN = 0x08000000, LENGTH = 62K - 256
