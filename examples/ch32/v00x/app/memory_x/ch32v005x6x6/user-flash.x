/* CH32V005 application memory layout for user-flash bootloader (32K flash, 6K RAM).
 *
 * Flash map:
 *   0x0000_0000 .. 0x0000_07FF  bootloader   2 KB
 *   0x0000_0800 .. 0x0000_7EFF  application  30 KB - 256 B
 *   0x0000_7F00 .. 0x0000_7FFF  boot meta    256 B
 */
MEMORY
{
    ...
    CODE : ORIGIN = 0x00000000 + 2K, LENGTH = 30K - 256
