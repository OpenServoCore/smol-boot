...
- `tinyboot-ch32`: half-duplex raises HDSEL before TE — the reverse order latched the TX output LOW until the first own transmission, clamping the wire from init (measured on CH32V006).
