...
Rust bootloader for resource-constrained microcontrollers. Fits in the CH32V003's 1920-byte system flash with full trial boot, CRC16 app validation, and OB-based metadata — leaving the entire 16KB user flash for the application.
